...
const LS_KEY = 'verideep.annotations.v1'
const LS_KB = 'verideep.knowledge.v1'
const LEGACY_LS_KEY = ['ver', 'da.annotations.v1'].join('')
const LEGACY_LS_KB = ['ver', 'da.knowledge.v1'].join('')
...
export const useAnnotationStore = create<AnnotationState>((set, get) => ({
  annotations: load<Record<string, ReportAnnotations>>(LS_KEY, {}, LEGACY_LS_KEY),
  knowledge: load<KBEntry[]>(LS_KB, [], LEGACY_LS_KB),
