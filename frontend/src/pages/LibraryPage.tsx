  ...
  return (
    <div className="mx-auto max-w-content px-8 py-8">
      <header className="flex items-center justify-between">
        ...
        <button
          onClick={() => navigate('/')}
          className="inline-flex items-center gap-2 rounded-btn bg-primary text-bg px-5 h-11 font-medium text-bg shadow-card transition-all hover:bg-primary-soft hover:shadow-float"
        >
          <Plus size={18} /> 发起新调研
        </button>
      </header>
      ...
      {loading ? (
        ...
        <div className="mt-16 flex flex-col items-center justify-center gap-4 text-center">
          ...
          <button
            onClick={() => navigate('/')}
            className="inline-flex items-center gap-2 rounded-btn bg-primary text-bg px-6 h-11 font-medium text-bg shadow-card hover:bg-primary-soft"
          >
            <Plus size={18} /> 开始调研
          </button>
        </div>
