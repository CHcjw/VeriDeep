    ...
    <div className="mx-auto max-w-content px-8 py-8">
      ...
      {loading ? (
        ...
        <div className="mt-16 flex flex-col items-center gap-3 text-center">
          ...
          <button
            onClick={() => navigate('/')}
            className="mt-2 inline-flex items-center gap-2 rounded-btn bg-primary text-bg px-6 h-11 font-medium text-bg shadow-card hover:bg-primary-soft"
          >
            发起新调研
          </button>
        </div>
              ...
              <VCard hover={false}>
                ...
                <div className="mt-3 flex gap-2">
                  ...
                  <button
                    ...
                    className="grid h-10 w-10 place-items-center rounded-btn bg-primary text-bg hover:bg-primary-soft"
                  >
                    <BellPlus size={16} />
                  </button>
                </div>
  ...
  return (
    <button
      ...
      className={`rounded-chip px-3 py-1 text-tag transition-colors ${
        active ? 'bg-primary text-bg' : 'bg-bg text-ink-2 hover:bg-primary-tint'
      }`}
    >
      {label}
    </button>
