          ...
          <div className="min-h-0 flex-1 overflow-y-auto px-6 py-5">
            {thoughts.length === 0 ? (
              <div className="flex h-full flex-col items-center justify-center gap-3 text-ink-3">
                ...
                >
                  <VeriDeepMark size={32} className="text-primary-soft" />
                </motion.div>
              ...
              {finished && reportId && (
                ...
                >
                  ...
                  <button
                    ...
                    className="rounded-btn bg-primary text-bg px-4 h-9 text-aux font-medium text-bg hover:bg-primary-soft"
                  >
                    查看报告
                  </button>
                </motion.div>
