"""ECharts option 生成（VeriDeep 深海情报配色）。后端报告内联图表用。"""
...
SERIES = ["#00D5FF", "#35F2D0", "#FFB84D", "#7AA7FF", "#48D597", "#FF6B7A"]
SENTIMENT = {"pos": "#48D597", "neu": "#6F8390", "neg": "#FF6B7A"}
...
def feature_radar(title: str, dimensions: List[str], series: List[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    return {
        ...
        "radar": {
            ...
            "splitArea": {"areaStyle": {"color": ["#07111A", "#0D1B26"]}},
